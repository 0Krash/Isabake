...
export const createSyncDiagnosticsActions = ({
  ...
  },
  {
    ...
    run: () => runners.runListConflictsDevCheck(),
  },
  {
    key: 'conflictSummary',
    label: 'Show conflict summary',
    run: () => runners.runConflictSummaryDevCheck(),
  },
  {
    key: 'resolveLatestPreferLocal',
    label: 'Resolve latest conflict: prefer local',
    run: () => runners.runResolveLatestConflictPreferLocalDevCheck(),
  },
  {
    key: 'resolveLatestPreferRemote',
    label: 'Resolve latest conflict: prefer remote',
    run: () => runners.runResolveLatestConflictPreferRemoteDevCheck(),
  },
  {
    key: 'conflictResolutionEndToEnd',
    label: 'Conflict resolution end-to-end check',
    run: () => runners.runConflictResolutionDevCheck({ groupId }),
  },
  {
    key: 'conflictPreferLocal',
    label: 'Conflict prefer-local check',
    run: () => runners.runConflictPreferLocalDevCheck({ groupId }),
  },
  {
    key: 'legacyPushPull',
